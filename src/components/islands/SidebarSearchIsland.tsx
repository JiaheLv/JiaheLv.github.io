  ...
  return (
    ...
    >
      ...
      <input 
        ...
        id="sidebar-search" 
        name="q"
        className="block w-full rounded-lg border border-slate-200 bg-[rgba(255,228,196,0.4)] p-2 pl-10 text-sm outline-none focus:border-2 focus:border-black focus:outline-none focus:ring-0"
